...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First(firstintrusct => firstintrusct.PrimaryInstructor.FirstName == "Kate");
        ...
        {
            var ActualCohort = PracticeData.First(jrinstruct3 => jrinstruct3.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(fod => fod.PrimaryInstructor.FirstName == "Zelda");
