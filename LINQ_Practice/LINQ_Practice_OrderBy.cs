...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(cohortname => cohortname.Name).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(bday => bday.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(youngest => youngest.Birthday.Year).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(lastname => lastname.LastName).ToList();
