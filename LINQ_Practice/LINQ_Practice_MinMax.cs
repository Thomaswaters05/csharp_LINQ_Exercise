...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var maxValue = PracticeData[2].Students.Max(youngest => youngest.Birthday); //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var minValue = PracticeData[2].Students.Min(oldest => oldest.Birthday); ; //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var maxValue = PracticeData.Max(maxx => maxx.JuniorInstructors.Count); 
