...
namespace LINQ_Practice
{
     ...
     */
    {
        ...
        {
            var expected = PracticeData.Select(allinstructors => allinstructors.PrimaryInstructor).ToList();
        ...
        {
            var expected = PracticeData.SelectMany(allstudents => allstudents.Students).ToList();
        ...
        {
            var expected = PracticeData.Select(first => first.PrimaryInstructor.FirstName).ToList();
        ...
        {
            var expected = PracticeData.Select(allcohort => allcohort.Name).ToList();
