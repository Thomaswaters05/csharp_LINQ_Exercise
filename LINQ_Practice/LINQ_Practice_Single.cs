...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.Single(jr => jr.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.Single(bday => bday.PrimaryInstructor.Birthday > DateTime.Now);
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(zeldaornull => zeldaornull.PrimaryInstructor.FirstName == "Zelda");
        ...
        {
            var shouldThrowException = PracticeData.Single(both => both.Active == false && both.FullTime == false);
        }
        ...
        {
            var shouldThrowException = PracticeData.SingleOrDefault(twojr => twojr.JuniorInstructors.Count == 2);
        }
    }
}
